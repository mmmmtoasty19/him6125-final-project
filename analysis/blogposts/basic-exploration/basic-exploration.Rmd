...
```{r g2, echo=echoChunks, results='show', message=FALSE, fig.width=9, out.width="900px"}
```


# By County

```{r g3, echo=echoChunks, results='show', message=FALSE, fig.width=9,fig.height=5, out.width="900px", warning=FALSE}
```



```{r g4, echo=echoChunks, results='show', message=FALSE, fig.width=9, fig.height=5, out.width="900px",warning=FALSE}
```


```{r animate, echo=echoChunks, results='hide', message=FALSE, fig.width=9, fig.height=5, out.width="900px",warning=FALSE}
```

![](./figure_rmd/animate_1.gif)
