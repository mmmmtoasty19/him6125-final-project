...
HOW DO I EXPLAIN THE ABOVE GRAPH? - I don't know how to describe the loess line.
...
The following chart displays the density curve of the percentage change for both rural and urban counties.  It is notable that the mean of change for Urban counties is actually higher then the mean for rural counties.  However, we also see that most change for both regions is positive growth. In fact only 16 rural, and 10 Urban counties experienced negative change in the given time frame.  While 35 rural and 34 urban counties experience growth in the same period. 
