...
```{r county-distribution-histogram, echo=echoChunks, results='show', message=FALSE, fig.width=9,fig.height=5, out.width="900px", warning=FALSE}
```
...
```{r c-g3, echo=echoChunks, results='show', message=FALSE, fig.width=9,fig.height=6, out.width="900px", warning=FALSE}
```
...
```{r pct-table, echo=echoChunks, results='show', message=FALSE, fig.width=9,fig.height=5, out.width="900px", warning=FALSE}
```
