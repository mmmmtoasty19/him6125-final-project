...
```{r g3, echo=echoChunks, results='show', message=FALSE, fig.width=9,fig.height=5, out.width="900px"}
```



```{r g4, echo=echoChunks, results='show', message=FALSE, fig.width=9, fig.height=5, out.width="900px"}
```
